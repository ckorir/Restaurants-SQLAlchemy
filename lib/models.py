...
class Restaurant(Base):
    ...
    # Return reviews associated with the restaurant
    def restaurant_reviews(self):
        return self.reviews

    # Returns one restaurant instance with the highest price
    @classmethod
...
class Customer(Base):
    ...
    # Return reviews left by a customer
    ...
    # Allows customer to add a new review of a restaurant given a restaurant's id
